...
function [Cp_Final,C_Links] = C_Matrix(X,X_dot)
...
%% Mass Matrix 
    %% Chain1
    C1_1=Jw1_1'*I1_1*dJw1_1+Jw1_1'*Skew(Jw1_1*X_dot)*I1_1*Jw1_1;
    C2_1=Jw2_1'*I2_1*dJw2_1+Jw2_1'*Skew(Jw2_1*X_dot)*I2_1*Jw2_1;
    C1=C1_1+C2_1;
    %% Chain 2
    C1_2=Jw1_2'*I1_2*dJw1_2+Jw1_2'*Skew(Jw1_2*X_dot)*I1_2*Jw1_2;
    C2_2=Jw2_2'*I2_2*dJw2_2+Jw2_2'*Skew(Jw2_2*X_dot)*I2_2*Jw2_2;
    C2=C1_2+C2_2;
    %% Chain3
    C1_3=Jw1_3'*I1_3*dJw1_3+Jw1_3'*Skew(Jw1_3*X_dot)*I1_3*Jw1_3;
    C2_3=Jw2_3'*I2_3*dJw2_3+Jw2_3'*Skew(Jw2_3*X_dot)*I2_3*Jw2_3;
    C3=C1_3+C2_3;
    
    %% Moving Platform
    Omega_p=E*X_dot;    
    Cp=Skew(Omega_p)*Ip;  
    Cp_Final=E'*Mp*Edot+E'*Cp*E;
    
    %% Total Links
    C_Links=C1+C2+C3;   
    
    C_Final=C_Links+Cp_Final;
   
    
    %% Mdot-2C
    
    Mdot1_1=dJw1_1'*I1_1*Jw1_1+Jw1_1'*(Skew(omega1_1)*I1_1+I1_1*Skew(omega1_1)')*Jw1_1+Jw1_1'*I1_1*dJw1_1;
    Mdot2_1=dJw2_1'*I2_1*Jw2_1+Jw2_1'*(Skew(omega2_1)*I2_1+I2_1*Skew(omega2_1)')*Jw2_1+Jw2_1'*I2_1*dJw2_1;
    Mdot1=Mdot1_1+Mdot2_1;
    
    Mdot1_2=dJw1_2'*I1_2*Jw1_2+Jw1_2'*(Skew(omega1_2)*I1_2+I1_2*Skew(omega1_2)')*Jw1_2+Jw1_2'*I1_2*dJw1_2;
    Mdot2_2=dJw2_2'*I2_2*Jw2_2+Jw2_2'*(Skew(omega2_2)*I2_2+I2_2*Skew(omega2_2)')*Jw2_2+Jw2_2'*I2_2*dJw2_2;
    Mdot2=Mdot1_2+Mdot2_2;

    Mdot1_3=dJw1_3'*I1_3*Jw1_3+Jw1_3'*(Skew(omega1_3)*I1_3+I1_3*Skew(omega1_3)')*Jw1_3+Jw1_3'*I1_3*dJw1_3;
    Mdot2_3=dJw2_3'*I2_3*Jw2_3+Jw2_3'*(Skew(omega2_3)*I2_3+I2_3*Skew(omega2_3)')*Jw2_3+Jw2_3'*I2_3*dJw2_3;
    Mdot3=Mdot1_3+Mdot2_3;

    MdotP=(Skew(Omega_p)*Ip+Ip*Skew(Omega_p)');
    
    Mdot=Mdot1+Mdot2+Mdot3;
    % Cheak
    Skew_Sym=Mdot-2*C_Links;
